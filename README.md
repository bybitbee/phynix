...
![Test Panel](https://github.com/phynix/pterodactyl-installer/actions/workflows/panel.yml/badge.svg)
![Test Wings](https://github.com/phynix/pterodactyl-installer/actions/workflows/wings.yml/badge.svg)
![Shellcheck](https://github.com/phynix/pterodactyl-installer/actions/workflows/shellcheck.yml/badge.svg)
[![License: GPL v3](https://img.shields.io/github/license/phynix/pterodactyl-installer)](LICENSE)
[![Discord](https://img.shields.io/discord/682342331206074373?label=&logo=discord&logoColor=ffffff&color=7389D8&labelColor=6A7EC2)](https://phynix.rf.gd/discord)
...
For help and support regarding the script itself and **not the official Pterodactyl project**, you can join the [Discord Chat](https://phynix.rf.gd).
...
Copyright (C) 2024, bybitbee, <bybitbee@proton.me>, and contributors!

- Created by [bybitbee](https://github.com/bybitbee)
